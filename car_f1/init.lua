...
-- For checking speed on single player even you can change singleplayer to etim3
	minetest.chat_send_player("singleplayer", "SPEED: "..round(math.abs(self.v*3.6), 1).." kn/s");
